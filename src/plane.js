// Sylvester.Plane class - depends on Sylvester.Vector. Some methods require Sylvester.Matrix and Sylvester.Line.
...
Sylvester.Plane.prototype = {
  ...
  intersectionWith: function(obj) {
    ...
    if (obj.direction) {
      ...
      // obj is a plane
      var direction = this.normal.cross(obj.normal).toUnitSylvester.Vector();
  ...
  setSylvester.Vectors: function(anchor, v1, v2) {
...
Sylvester.Plane.create = function(anchor, v1, v2) {
  ...
  return P.setSylvester.Vectors(anchor, v1, v2);
};
...
Sylvester.Plane.fromPoints = function(points) {
  ...
  totalN = totalN.add(Sylvester.Vector.create([
    ...
    (A[2] - B[2]) * (C[0] - B[0]) - (A[0] - B[0]) * (C[2] - B[2]),
    (A[0] - B[0]) * (C[1] - B[1]) - (A[1] - B[1]) * (C[0] - B[0])
  ]).toUnitSylvester.Vector()).add(Sylvester.Vector.create([
