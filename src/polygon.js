// Sylvester.Polygon class - depends on Sylvester.Vector, Sylvester.Plane, Sylvester.Polygon.Vertex and Sylvester.LinkedList.
...
Sylvester.Polygon.prototype = {
  ...
  translate: function(vector) {
    ...
    this.updateTriangleSylvester.Planes(function(plane) { return plane.translate(vector); });
    return this;
  },
  ...
  rotate: function(t, line) {
    ...
    this.updateTriangleSylvester.Planes(function(plane) { return plane.rotate(R, line); });
    return this;
  },
  ...
  scale: function(k, point) {
    ...
    this.updateTriangleSylvester.Planes(function(plane) { return Sylvester.Plane.create(anchor, plane.normal); });
    return this;
  },
  ...
  //
  //   poly.updateTriangleSylvester.Planes(function(plane) { return plane.rotate(t, line); });
  //
  ...
  updateTriangleSylvester.Planes: function(fn) {
    var i;
