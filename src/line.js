// Sylvester.Line class - depends on Sylvester.Vector, and some methods require Sylvester.Matrix and Sylvester.Plane.
...
Sylvester.Line.prototype = {
  ...
  distanceFrom: function(obj) {
    ...
    if (obj.direction) {
      ...
      var N = this.direction.cross(obj.direction).toUnitSylvester.Vector().elements;
  ...
  setSylvester.Vectors: function(anchor, direction) {
...
Sylvester.Line.create = function(anchor, direction) {
  ...
  return L.setSylvester.Vectors(anchor, direction);
};
