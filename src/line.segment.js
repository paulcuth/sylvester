...
Sylvester.Line.Segment.prototype = {
  ...
  bisectingSylvester.Plane: function() {
    return Sylvester.Plane.create(this.midpoint(), this.toSylvester.Vector());
  },
  ...
  contains: function(obj) {
    ...
    var vect = this.toSylvester.Vector();
